...
class Lookbook_Banner extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Dimax - Lookbook Banner', 'dimax' );
	}
	...
	protected function section_content_option() {
		...
		$control = apply_filters( 'dimax_banner_section_product_number', 2 );
		for ( $i = 1; $i <= $control; $i ++ ) {
			...
			$this->add_responsive_control(
				...
				[
					...
					'size_units' => [ '%', 'px' ],
					'selectors'  => [
						'{{WRAPPER}} .dimax-lookbook-banner .dimax-lookbook-item.item-' . $i . '' => 'left: {{SIZE}}{{UNIT}};',
					],
				]
			);
			...
			$this->add_responsive_control(
				...
				[
					...
					'size_units' => [ '%', 'px' ],
					'selectors'  => [
						'{{WRAPPER}} .dimax-lookbook-banner .dimax-lookbook-item.item-' . $i . ' ' => 'top: {{SIZE}}{{UNIT}};',
					],
				]
			);
			...
			$this->add_responsive_control(
				...
				[
					...
					'size_units' => [ 'px' ],
					'selectors'  => [
						'{{WRAPPER}} .dimax-lookbook-banner .dimax-lookbook-item.item-' . $i . ' .product-item' => 'left: {{SIZE}}{{UNIT}};',
					],
				]
			);
			...
			$this->add_responsive_control(
				...
				[
					...
					'size_units' => [ 'px' ],
					'selectors'  => [
						'{{WRAPPER}} .dimax-lookbook-banner .dimax-lookbook-item.item-' . $i . ' .product-item' => 'top: {{SIZE}}{{UNIT}};',
					],
				]
			);
		}
	...
	protected function section_style_lookbook() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .dimax-lookbook-banner .dimax-lookbook-item' => ' --rz-lookbook-color-primary: {{VALUE}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .dimax-lookbook-banner .product-item .product-name',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .dimax-lookbook-banner .product-item .product-name' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .dimax-lookbook-banner .product-item .product-price',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .dimax-lookbook-banner .product-item .product-price' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .dimax-lookbook-banner .product-item .product-price ins' => 'color: {{VALUE}}',
				],
			]
		);
	...
	protected function render() {
		...
		$content_html[] = '<div class="dimax-lookbook-banner__item">' . $banner_html . '</div>';
