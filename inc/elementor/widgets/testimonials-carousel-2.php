...
class Testimonials_Carousel_2 extends Widget_Base {
	...
	public function get_name() {
		return 'dimax-testimonials-carousel-2';
	}
	...
	protected function content_settings_controls() {
		...
		$repeater->start_controls_tab( 'content_other', [ 'label' => esc_html__( 'Content', 'dimax' ) ] );
		...
		$repeater->start_controls_tab( 'content_text', [ 'label' => esc_html__( 'Author', 'dimax' ) ] );
	...
	protected function carousel_settings_controls() {
		...
		$this->add_control(
			...
			[
				...
				'prefix_class' => 'dimax-testimonials-carousel-2__centeredslides-',
				'conditions' => [
					'terms' => [
						[
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'frontend_available' => true,
				'prefix_class' => 'dimax-testimonials-carousel-2__slidesperviewauto-',
				'conditions' => [
					'terms' => [
						[
							'name' => 'centeredSlides',
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}}.dimax-testimonials-carousel-2__slidesperviewauto-yes .dimax-testimonials-carousel-2' => 'margin-right: -{{SIZE}}{{UNIT}};',
	...
	protected function section_items_style() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .dimax-testimonials-carousel-2 .testimonials-item' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .dimax-testimonials-carousel-2 .author-group:after' => 'height: calc(100% + {{TOP}}{{UNIT}} + {{BOTTOM}}{{UNIT}} ) ; top: calc(0px - {{TOP}}{{UNIT}} ) ;',
					'{{WRAPPER}} .dimax-testimonials-carousel-2 .author-group:before' => 'width: calc(100% + {{TOP}}{{UNIT}} + {{BOTTOM}}{{UNIT}} ) ; right: calc(0px - {{TOP}}{{UNIT}} ) ;',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimax-testimonials-carousel-2 .testimonials-item' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimax-testimonials-carousel-2 .testimonials-item' => 'border-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			'header_spacing',
			[
				'label'     => esc_html__( 'Header Spacing', 'dimax' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => [
					'px' => [
						'min' => 0,
				...
				'selectors' => [
					'{{WRAPPER}} .dimax-testimonials-carousel-2__header' => 'margin-bottom: {{SIZE}}{{UNIT}}',
				],
			]
		);
	...
	protected function section_content_style() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .dimax-testimonials-carousel-2__header .testi-image' => 'border-radius: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .dimax-testimonials-carousel-2__header .testi-image img' => 'border-radius: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .dimax-testimonials-carousel-2__header .testi-image' => 'margin-right: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .dimax-testimonials-carousel-2__header .subtitle',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimax-testimonials-carousel-2__header .subtitle' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .dimax-testimonials-carousel-2__header .subtitle' => 'margin-bottom: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .dimax-testimonials-carousel-2__header .testi-title',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimax-testimonials-carousel-2__header .testi-title' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .dimax-testimonials-carousel-2__header .testi-title' => 'margin-bottom: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => 'bottom',
				'prefix_class' => 'dimax-testimonials-carousel-2__rating_position-'
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .dimax-testimonials-carousel-2__header .dimax-svg-icon' => 'font-size: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimax-testimonials-carousel-2__header .dimax-svg-icon' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimax-testimonials-carousel-2__header .dimax-svg-icon.rate-active' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .dimax-testimonials-carousel-2__footer .testi-desc',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimax-testimonials-carousel-2__footer .testi-desc' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .dimax-testimonials-carousel-2__footer .testi-desc' => 'margin-bottom: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .dimax-testimonials-carousel-2__footer .testi-meta',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimax-testimonials-carousel-2__footer .testi-meta' => 'color: {{VALUE}};',
				],
			]
		);
	...
	protected function section_author_style() {
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .dimax-testimonials-carousel-2 .testi-author-title',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimax-testimonials-carousel-2 .testi-author-title' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .dimax-testimonials-carousel-2 .testi-author-title' => 'margin-bottom: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .dimax-testimonials-carousel-2 .testi-author-name',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimax-testimonials-carousel-2 .testi-author-name' => 'color: {{VALUE}};',
				],
			]
		);
	...
	protected function section_carousel_style() {
		...
		$this->add_control(
			...
			[
				...
				'default'   => 'left',
				'selectors'   => [
					'{{WRAPPER}} .dimax-testimonials-carousel-2 .swiper-scrollbar' => '{{VALUE}}',
				],
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .dimax-testimonials-carousel-2 .swiper-scrollbar' => 'max-width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .dimax-testimonials-carousel-2 .swiper-scrollbar' => 'margin-top: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimax-testimonials-carousel-2 .swiper-scrollbar' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimax-testimonials-carousel-2 .swiper-scrollbar-drag' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .dimax-testimonials-carousel-2 .swiper-pagination-bullet' => 'margin: 0 {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .dimax-testimonials-carousel-2 .swiper-pagination-bullet' => 'width: {{SIZE}}{{UNIT}};height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .dimax-testimonials-carousel-2 .swiper-pagination' => 'margin-top: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimax-testimonials-carousel-2 .swiper-pagination-bullet:before' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimax-testimonials-carousel-2 .swiper-pagination-bullet-active:before, {{WRAPPER}} .dimax-testimonials-carousel-2 .swiper-pagination-bullet:hover:before' => 'background-color: {{VALUE}};',
				],
			]
		);
	...
	protected function render() {
		...
		$classes = [
			'dimax-testimonials-carousel-2 swiper-container',
		...
		if ( ! empty ( $els ) ) {
			foreach ( $els as $index => $item ) {
				...
				$output_content[] = $image_author == '' ? '' : '<div class="dimax-testimonials-carousel-2__gr">';
				$output_content[] = '<div class="dimax-testimonials-carousel-2__header">';
				...
				$output_content[] = '</div>';
				$output_content[] = '</div>';
				$output_content[] = '<div class="dimax-testimonials-carousel-2__footer">';
				$output_content[] = $desc;
		...
		echo sprintf(
			'<div %s><div class="dimax-testimonials-carousel-2__inner swiper-wrapper"> %s</div><div class="swiper-pagination"></div><div class="swiper-scrollbar"></div></div>',
