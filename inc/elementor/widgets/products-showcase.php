...
class Products_Showcase extends Widget_Base {
	...
	public function get_name() {
		return 'dimax-products-showcase';
	}
	...
	public function get_title() {
		return __( 'Dimax - Products Showcase', 'dimax' );
	}
	...
	protected function section_products_settings_controls() {
		...
		$this->add_control(
			'hide_image',
			[
				'label'     => esc_html__( 'Hide Image Large on Mobile', 'dimax' ),
		...
		$this->add_control(
			'show_featured',
			[
				'label'     => esc_html__( 'Featured Icon on Tablet & Mobile', 'dimax' ),
				'type'      => Controls_Manager::SWITCHER,
				'label_off' => __( 'Hide', 'dimax' ),
				'label_on'  => __( 'Show', 'dimax' ),
				'return_value' => 'show',
	...
	protected function section_content_style_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .dimax-products-showcase' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .dimax-products-showcase .showcase-box' => 'padding-left: {{SIZE}}{{UNIT}};',
				],
				'separator' => 'before',
			]
		);
	...
	protected function section_heading_style_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .dimax-products-showcase .dimax-shortcode-title' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->start_controls_tab( 'heading_title', [ 'label' => esc_html__( 'Title', 'dimax' ) ] );
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .dimax-products-showcase .dimax-shortcode-title' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .dimax-products-showcase .dimax-shortcode-title',
			]
		);
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimax-products-showcase .dimax-shortcode-title' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->start_controls_tab( 'heading_subtitle', [ 'label' => esc_html__( 'Sub Title', 'dimax' ) ] );

		$this->add_group_control(
			Group_Control_Typography::get_type(),
			[
				'name'     => 'heading_style_subtitle',
				'selector' => '{{WRAPPER}} .dimax-products-showcase .dimax-shortcode-subtitle',
			]
		);
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimax-products-showcase .dimax-shortcode-subtitle' => 'color: {{VALUE}};',
				],
			]
		);
	...
	protected function section_carousel_style_controls() {
		$this->start_controls_section(
			...
			[
				'label' => __( 'Carousel Settings', 'dimax' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .dimax-products-showcase .rz-swiper-button' => 'font-size: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimax-products-showcase .rz-swiper-button' => 'color: {{VALUE}};',
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimax-products-showcase .rz-swiper-button:hover:not(.swiper-button-disabled)' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [
					'{{WRAPPER}} .dimax-products-showcase.dimax-swiper-carousel-elementor .rz-swiper-button-next' => 'right: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .dimax-products-showcase.dimax-swiper-carousel-elementor .rz-swiper-button-prev' => 'left: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [
					'{{WRAPPER}} .dimax-products-showcase .rz-swiper-button' => 'top: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .dimax-products-showcase .swiper-pagination .swiper-pagination-bullet' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimax-products-showcase .swiper-pagination .swiper-pagination-bullet:before' => 'background-color: {{VALUE}};',
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimax-products-showcase .swiper-pagination .swiper-pagination-bullet.swiper-pagination-bullet-active:before, {{WRAPPER}} .dimax-products-showcase .swiper-pagination .swiper-pagination-bullet:hover:before' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [
					'{{WRAPPER}} .dimax-products-showcase .swiper-container-horizontal > .swiper-pagination-bullets .swiper-pagination-bullet' => 'margin-left: {{SIZE}}{{UNIT}}; margin-right: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [
					'{{WRAPPER}} .dimax-products-showcase .swiper-pagination' => 'margin-top: {{SIZE}}{{UNIT}};',
				],
			]
		);
	...
	protected function render() {
		...
		$classes = [
			'dimax-products-showcase dimax-swiper-carousel-elementor',
		...
		if ( $settings['sub_title'] ) {
			$title = sprintf( '<h4 class="dimax-shortcode-subtitle">%s</h4>', esc_html( $settings['sub_title'] ) );
		}

		if ( $settings['title'] ) {
			$title .= sprintf( '<h3 class="dimax-shortcode-title">%s</h3>', esc_html( $settings['title'] ) );
		}

		echo '<div class="showcase-box">';

		echo '<div class="dimax-box-title">'. $title .'</div>';
		...
		echo sprintf( '%s%s', \Dimax\Addons\Helper::get_svg('chevron-left', 'rz-swiper-showcase-button-prev rz-swiper-button-prev rz-swiper-button'),
								\Dimax\Addons\Helper::get_svg('chevron-right', 'rz-swiper-showcase-button-next rz-swiper-button-next rz-swiper-button') );
