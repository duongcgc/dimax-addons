...
class Images_Carousel_2 extends Widget_Base {
	...
	public function get_name() {
		return 'dimax-images-carousel-2';
	}
	...
	protected function content_settings_controls() {
		...
		$repeater->add_responsive_control(
			...
			[
				'label'      => esc_html__( 'Position X', 'dimax' ),
				...
				'selectors'  => [
					'{{WRAPPER}} .dimax-images-carousel-content__sale' => 'top: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$repeater->add_responsive_control(
			...
			[
				'label'      => esc_html__( 'Position Y', 'dimax' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				'range'      => [
					'px' => [
				...
				'selectors'  => [
					'{{WRAPPER}} .dimax-images-carousel-content__sale' => 'right: {{SIZE}}{{UNIT}}',
				],
			]
		);
	...
	protected function section_content_style(){
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .dimax-images-carousel-2 .dimax-images-carousel-content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .dimax-images-carousel-2 .dimax-images-carousel-content .dimax-images-carousel__title' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .dimax-images-carousel-2 .dimax-images-carousel-content .dimax-images-carousel__title' => 'background-color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .dimax-images-carousel-2 .dimax-images-carousel__title' => 'color: {{VALUE}}',
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .dimax-images-carousel-2 .dimax-images-carousel__title',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .dimax-images-carousel-2 .dimax-images-carousel-content .dimax-images-carousel__title' => 'margin-bottom: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .dimax-images-carousel-2 .button-text' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'       => Controls_Manager::COLOR,
				'selectors'  => [
					'{{WRAPPER}} .dimax-images-carousel-2 .button-text' => 'background-color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'       => Controls_Manager::COLOR,
				'selectors'  => [
					'{{WRAPPER}} .dimax-images-carousel-2 .button-text' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				'name'     => 'btn_typography',
				'selector' => '{{WRAPPER}} .dimax-images-carousel-2 .button-text',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'toggle'    => false,
				'selectors' => [
					'{{WRAPPER}} .dimax-images-carousel-2 .button-text' => 'border-style: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'default'   => [ ],
				'selectors' => [
					'{{WRAPPER}} .dimax-images-carousel-2 .button-text' => 'border-width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimax-images-carousel-2 .button-text' => 'border-color: {{VALUE}};',
				],
			]
		);
	...
	protected function section_style_sale() {
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .dimax-images-carousel-content__sale-betext',
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .dimax-images-carousel-content__sale-text',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .dimax-images-carousel-content__sale' => 'color: {{VALUE}}',
				],
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .dimax-images-carousel-content__sale' => 'background-color: {{VALUE}}',
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .dimax-images-carousel-content__sale' => 'width: {{SIZE}}{{UNIT}}',
				],
				'separator'  => 'before',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .dimax-images-carousel-content__sale' => 'height: {{SIZE}}{{UNIT}}',
				],
			]
		);
	...
	protected function section_carousel_style() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .dimax-images-carousel-2 .dimax-swiper-button' => 'font-size: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .dimax-images-carousel-2 .dimax-swiper-button' => 'width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .dimax-images-carousel-2 .dimax-swiper-button' => 'height: {{SIZE}}{{UNIT}};line-height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .dimax-images-carousel-2 .dimax-swiper-button-container' => 'right: {{SIZE}}{{UNIT}};',
					// '{{WRAPPER}} .dimax-images-carousel-2 .dimax-swiper-button-next' => 'right: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .dimax-images-carousel-2 .dimax-swiper-button-container' => 'bottom: {{SIZE}}{{UNIT}};transform:none;',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimax-images-carousel-2 .dimax-swiper-button' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimax-images-carousel-2 .dimax-swiper-button' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimax-images-carousel-2 .dimax-swiper-button:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimax-images-carousel-2 .dimax-swiper-button:hover' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .dimax-images-carousel-2 .swiper-pagination-bullet' => 'margin: 0 {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .dimax-images-carousel-2 .swiper-pagination-bullet:before' => 'width: {{SIZE}}{{UNIT}};height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .dimax-images-carousel-2 .swiper-pagination' => 'margin-top: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimax-images-carousel-2 .swiper-pagination-bullet:before' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimax-images-carousel-2 .swiper-pagination-bullet-active:before, {{WRAPPER}} .dimax-images-carousel-2 .swiper-pagination-bullet:hover:before' => 'background-color: {{VALUE}};',
				],
			]
		);
	...
	protected function render() {
		...
		<div <?php echo $this->get_render_attribute_string( 'wrapper' ); ?>>
			<div class="swiper-container">
				<div class="dimax-images-carousel-2__inner swiper-wrapper">
		<?php
				if ( ! empty ( $els ) ) {
					foreach ( $els as $index => $item ) {
						...
						$title = $item['title'] ? sprintf( '<div class="dimax-images-carousel__title">%s</div>', $item['title'] ) : '';
						...
						//sale
						$sale_betext = $item['sale_be_text'] ? sprintf('<div class="dimax-images-carousel-content__sale-betext">%s</div>',$item['sale_be_text']) : '';
						$sale_text = $item['sale_text'] ? sprintf('<div class="dimax-images-carousel-content__sale-text">%s</div>',$item['sale_text']) : '';

						$html_sale =  $sale_betext == '' && $sale_text == '' ? '' : sprintf('<div class="dimax-images-carousel-content__sale">%s %s</div>',$sale_betext, $sale_text);
						...
						$output_content .= '<div class="dimax-images-carousel-content">';
