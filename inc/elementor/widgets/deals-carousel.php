...
class Deals_Carousel extends Widget_Base {
	...
	protected function section_content_settings() {
		...
		$repeater->start_controls_tab( 'countdown_background', [ 'label' => esc_html__( 'Background', 'dimax' ) ] );
		...
		$repeater->add_group_control(
			...
			[
				...
				'types'    => [ 'classic' ],
				'selector' => '{{WRAPPER}} .dimax-deals-carousel {{CURRENT_ITEM}} .countdown-bg',
				'fields_options'  => [
					'background' => [
						'default' => 'classic',
					],
		...
		$repeater->start_controls_tab( 'countdown_content', [ 'label' => esc_html__( 'Content', 'dimax' ) ] );
		...
		$repeater->start_controls_tab( 'countdown_style', [ 'label' => esc_html__( 'Style', 'dimax' ) ] );
		...
		$repeater->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimax-deals-carousel {{CURRENT_ITEM}} .countdown-title' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$repeater->add_control(
			...
			[
				'label'     => esc_html__( 'Digits Color', 'dimax' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimax-deals-carousel {{CURRENT_ITEM}} .timer .digits' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimax-deals-carousel {{CURRENT_ITEM}} .timer .text' => 'color: {{VALUE}};',
				],
				'separator' => 'before',
			]
		);
		...
		$repeater->add_control(
			...
			[
				'label'     => esc_html__( 'Divider Color', 'dimax' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimax-deals-carousel {{CURRENT_ITEM}} .timer .divider' => 'color: {{VALUE}};',
				],
				'separator' => 'before',
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimax-deals-carousel {{CURRENT_ITEM}} .countdown-button a' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimax-deals-carousel {{CURRENT_ITEM}} .countdown-button a' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'vh', 'em' ],
				'selectors'  => [
					'{{WRAPPER}} .dimax-deals-carousel .countdown-slider' => 'height: {{SIZE}}{{UNIT}};',
				],
				'separator'  => 'before',
			]
		);
	...
	protected function section_general_style() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .dimax-deals-carousel .countdown-item' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->end_controls_section();
	...
	protected function section_title_style() {
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .dimax-deals-carousel .countdown-title',
			]
		);
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimax-deals-carousel .countdown-title' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .dimax-deals-carousel .countdown-title' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
				'separator' => 'before',
			]
		);
	...
	protected function section_countdown_style() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .dimax-deals-carousel .countdown-content' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
				'separator' => 'after',
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .dimax-deals-carousel .timer .digits',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimax-deals-carousel .timer .digits' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'default'   => [ ],
				'selectors' => [
					'{{WRAPPER}} .dimax-deals-carousel .timer .digits' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .dimax-deals-carousel .timer .text',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimax-deals-carousel .timer .text' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->start_controls_tab( 'countdown_style_divider', [ 'label' => esc_html__( 'Divider', 'dimax' ) ] );
		...
		$this->add_responsive_control(
			...
			[
				...
				'default'   => [ ],
				'selectors' => [
					'{{WRAPPER}} .dimax-deals-carousel .timer .divider' => 'font-size: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimax-deals-carousel .timer .divider' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'default'            => [],
				'selectors'          => [
					'{{WRAPPER}} .dimax-deals-carousel .timer .divider' => ' top:{{TOP}}{{UNIT}};right: {{RIGHT}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'default'   => [ ],
				'selectors' => [
					'{{WRAPPER}} .dimax-deals-carousel .timer' => 'padding-left: {{SIZE}}{{UNIT}}; padding-right: {{SIZE}}{{UNIT}};',
				],
			]
		);
	...
	protected function section_button_style() {
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .dimax-deals-carousel .countdown-button a',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'default'   => [ ],
				'selectors' => [
					'{{WRAPPER}} .dimax-deals-carousel .countdown-button a' => 'line-height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .dimax-deals-carousel .countdown-button a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimax-deals-carousel .countdown-button a' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimax-deals-carousel .countdown-button a' => 'color: {{VALUE}};',
				],
			]
		);
	...
	protected function section_carousel_style() {
			...
			$this->add_responsive_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .dimax-deals-carousel .rz-swiper-button' => 'font-size: {{SIZE}}{{UNIT}};',
					],
				]
			);
			...
			$this->add_responsive_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .dimax-deals-carousel .rz-swiper-button' => 'width: {{SIZE}}{{UNIT}};',
					],
				]
			);
			...
			$this->add_responsive_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .dimax-deals-carousel .rz-swiper-button' => 'height: {{SIZE}}{{UNIT}};line-height: {{SIZE}}{{UNIT}};',
					],
				]
			);
			...
			$this->add_responsive_control(
				...
				[
					...
					'size_units' => [ 'px', '%' ],
					'selectors'  => [
						'{{WRAPPER}} .dimax-deals-carousel .rz-swiper-button-prev' => 'left: {{SIZE}}{{UNIT}};',
						'{{WRAPPER}} .dimax-deals-carousel .rz-swiper-button-next' => 'right: {{SIZE}}{{UNIT}};',
					],
				]
			);
			...
			$this->add_responsive_control(
				...
				[
					...
					'size_units' => [ 'px', '%' ],
					'selectors'  => [
						'{{WRAPPER}} .dimax-deals-carousel .rz-swiper-button' => 'top: {{SIZE}}{{UNIT}};transform:none;',
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'default'   => '',
					'selectors' => [
						'{{WRAPPER}} .dimax-deals-carousel .rz-swiper-button' => 'color: {{VALUE}};',
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'default'   => '',
					'selectors' => [
						'{{WRAPPER}} .dimax-deals-carousel .rz-swiper-button' => 'background-color: {{VALUE}};',
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'default'   => '',
					'selectors' => [
						'{{WRAPPER}} .dimax-deals-carousel .rz-swiper-button:hover' => 'color: {{VALUE}};',
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'default'   => '',
					'selectors' => [
						'{{WRAPPER}} .dimax-deals-carousel .rz-swiper-button:hover' => 'background-color: {{VALUE}};',
					],
				]
			);
			...
			$this->add_responsive_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .dimax-deals-carousel .swiper-pagination-bullet' => 'margin: 0 {{SIZE}}{{UNIT}}',
					],
				]
			);
			...
			$this->add_responsive_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .dimax-deals-carousel .swiper-pagination-bullet' => 'width: {{SIZE}}{{UNIT}};height: {{SIZE}}{{UNIT}};',
					],
				]
			);
			...
			$this->add_responsive_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .dimax-deals-carousel .swiper-pagination' => 'bottom: {{SIZE}}{{UNIT}}',
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'default'   => '',
					'selectors' => [
						'{{WRAPPER}} .dimax-deals-carousel .swiper-pagination-bullet:before' => 'background-color: {{VALUE}};',
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'default'   => '',
					'selectors' => [
						'{{WRAPPER}} .dimax-deals-carousel .swiper-pagination-bullet-active:before, {{WRAPPER}} .dimax-deals-carousel .swiper-pagination-bullet:hover:before' => 'background-color: {{VALUE}};',
					],
				]
			);
	...
	protected function render() {
		...
		$this->add_render_attribute(
			'wrapper', 'class', [
				'dimax-deals-carousel dimax-swiper-carousel-elementor swiper-container ',
		...
		<div <?php echo $this->get_render_attribute_string( 'wrapper' ); ?>>
			<div class="linked-deals-carousel">
				<div class="dimax-deals-carousel__inner swiper-wrapper">
