...
class Category_Box extends Widget_Base {
	...
	protected function section_content() {
		$this->start_controls_section(
			'section_content',
			[ 'label' => esc_html__( 'Category Box', 'dimax' ) ]
		);
		...
		$repeater->add_control(
			'sub_cat',
			[
				'label'       => esc_html__( 'Category Name', 'dimax' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'This is cat name', 'dimax' ),
			]
		);
		...
		$this->add_control(
			'sub_categories',
			[
				'label'         => esc_html__( 'Sub Categories', 'dimax' ),
				'type'          => Controls_Manager::REPEATER,
				'fields'        => $repeater->get_controls(),
				'default'       => [
					[
						'sub_cat' => esc_html__( 'This is cat name 1', 'dimax' ),

					],[
						'sub_cat' => esc_html__( 'This is cat name 2', 'dimax' ),

					],[
						'sub_cat' => esc_html__( 'This is cat name 3', 'dimax' ),

					],[
						'sub_cat' => esc_html__( 'This is cat name 4', 'dimax' ),
	...
	protected function section_style_category() {
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .dimax-category-box',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}}.dimax-position-next-image .dimax-category-box' => 'background-color: {{VALUE}};',
					'{{WRAPPER}}.dimax-position-under-image .dimax-category-box__content' => 'background-color: {{VALUE}};',
				],
			]
		);
	...
	protected function section_style_image() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}}.dimax-position-next-image .dimax-category-box__img' => 'max-width: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}}.dimax-position-under-image .dimax-category-box__img' => 'margin-bottom: {{SIZE}}{{UNIT}}',
				],
				'condition' => [
	...
	protected function section_style_content() {
		...
		$this->add_responsive_control(
			...
			[
				'label' => __( 'Content Position', 'dimax' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'next-image',
				'options' => [
					'under-image' 	=> __( 'Under Image', 'dimax' ),
					'next-image' 	=> __( 'Next To Image', 'dimax' ),
				],
				'prefix_class' 	=> 'dimax-position%s-',
				'device_args' => [
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .dimax-category-box' => 'align-items: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .dimax-category-box__content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'separator' 	=> 'before',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .dimax-category-box__content .category-title' => 'margin-bottom: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .dimax-category-box__content .category-title',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimax-category-box__content .category-title' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .dimax-category-box__content .sub-cat',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimax-category-box__content .sub-cat' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .dimax-category-box__content .sub-cat:not(:last-child)' => 'margin-bottom: {{SIZE}}{{UNIT}}',
				],
			]
		);
	...
	protected function render() {
		...
		$image = $image ? sprintf('<div class="dimax-category-box__img">%s</div>',$image) : '';
		...
		if ( ! empty ( $els ) ) {
	 	...
	 	$content = sprintf('<div class="dimax-category-box__content">%s %s</div>', $title, implode('', $output));
