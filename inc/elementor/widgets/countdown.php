...
class Countdown extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Razzi - Countdown', 'dimax' );
	}
	...
	protected function section_general_style() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'   => [
					'{{WRAPPER}} .dimax-time-countdown' => 'justify-content: {{VALUE}}',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .dimax-time-countdown .timer' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->end_controls_section();
	...
	protected function section_digit_style() {
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimax-time-countdown .timer .digits' => 'color: {{VALUE}};',
				],
			]
		);
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .dimax-time-countdown .timer .digits',
			]
		);
		$this->add_responsive_control(
			'digit_spacing',
			[
				...
				'default'   => [ ],
				'selectors' => [
					'{{WRAPPER}} .dimax-time-countdown .timer .digits' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->end_controls_section();
	...
	protected function section_text_style() {
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimax-time-countdown .timer .text' => 'color: {{VALUE}};',
				],
			]
		);
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .dimax-time-countdown .timer .text',
			]
		);
		$this->end_controls_section();
	}
	...
	protected function section_divider_style() {
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimax-time-countdown .timer .divider' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'default'   => [ ],
				'selectors' => [
					'{{WRAPPER}} .dimax-time-countdown .timer .divider' => 'font-size: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'default'            => [],
				'selectors'          => [
					'{{WRAPPER}} .dimax-time-countdown .timer .divider' => ' top:{{TOP}}{{UNIT}};right: {{RIGHT}}{{UNIT}}',
				],
			]
		);
	...
	protected function render() {
		...
		$this->add_render_attribute(
			'wrapper', 'class', [
				'dimax-time-countdown dimax-countdown',
			]
		);
