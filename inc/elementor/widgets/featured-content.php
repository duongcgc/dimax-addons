...
class Featured_Content extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Razzi - Featured Content', 'dimax' );
	}
	...
	protected function section_content() {
		...
		$repeater->start_controls_tab( 'text_content', [ 'label' => esc_html__( 'Line Text', 'dimax' ) ] );
		...
		$repeater->add_control(
			...
			[
				...
				'type'        => Controls_Manager::TEXTAREA,
				'default'     => esc_html__( 'This is the desc', 'dimax' ),
			]
		);

		$repeater->end_controls_tab();

		$repeater->start_controls_tab( 'featured_position_content', [ 'label' => esc_html__( 'Line Position', 'dimax' ) ] );
		...
		$repeater->add_responsive_control(
			...
			[
				...
				'size_units'     => [ '%', 'px' ],
				'selectors'      => [
					'{{WRAPPER}} .dimax-featured-content {{CURRENT_ITEM}}.featured-box' => 'margin-top: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$repeater->add_responsive_control(
			...
			[
				...
				'size_units'     => [ '%', 'px' ],
				'selectors'      => [
					'{{WRAPPER}} .dimax-featured-content {{CURRENT_ITEM}}.featured-box' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$repeater->add_responsive_control(
			...
			[
				'label'          => esc_html__( 'Line Width', 'dimax' ),
				'type'           => Controls_Manager::SLIDER,
				'range'          => [
					'px' => [
						'min' => 0,
				...
				'size_units'     => [ '%', 'px' ],
				'selectors'      => [
					'{{WRAPPER}} .dimax-featured-content {{CURRENT_ITEM}} .featured-control' => 'width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			'featureds_el',
			[
				'label'      => esc_html__( 'Lines Lists', 'dimax' ),
				'type'       => Controls_Manager::REPEATER,
				'show_label' => true,
				'fields'     => $repeater->get_controls(),
				'default'    => [
					[
						'title'          => esc_html__( 'This is title 1', 'dimax' ),
					],[
						'title'          => esc_html__( 'This is title 2', 'dimax' ),
					],[
						'title'          => esc_html__( 'This is title 3', 'dimax' ),
					],[
						'title'          => esc_html__( 'This is title 4', 'dimax' ),
					],
				],
			]
		);
	...
	protected function section_style() {
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimax-featured-content .featured-control' => '--rz-background-color-primary: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .dimax-featured-content .featured-title' => 'margin-bottom: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .dimax-featured-content .featured-title',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimax-featured-content .featured-title' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .dimax-featured-content .featured-desc',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimax-featured-content .featured-desc' => 'color: {{VALUE}};',
				],
			]
		);
