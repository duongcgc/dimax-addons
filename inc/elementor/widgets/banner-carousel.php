...
class Banner_Carousel extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Dimax - Banner Carousel', 'dimax' );
	}
	...
	protected function content_settings_controls() {
		...
		$repeater->add_control(
			...
			[
				'label'     => esc_html__( 'Background Ovelay', 'dimax' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimax-banner-carousel {{CURRENT_ITEM}} .banner-img:after' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			'elements',
			[
				'label'         => esc_html__( 'Banner Items', 'dimax' ),
				...
				'default'       => [
					[
						...
						'button_text' => esc_html__( 'Button Text', 'dimax' ),
					],
					[
						'title'       => esc_html__( 'This is the title', 'dimax' ),
						'image'       => [
	...
	protected function section_content_style() {
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .dimax-banner-carousel .banner-title',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimax-banner-carousel .banner-title' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'     => '',
				'prefix_class'   => 'dimax-banner-carousel__btn-position-',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .dimax-banner-carousel .button-text' => 'min-width: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'default'   => [ ],
				'selectors' => [
					'{{WRAPPER}} .dimax-banner-carousel .button-text' => ' line-height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .dimax-banner-carousel .button-text' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .dimax-banner-carousel .button-link' => 'padding-bottom: {{SIZE}}{{UNIT}}',
					'{{WRAPPER}}.dimax-banner-carousel__btn-position-center .button-link' => 'padding-top: {{SIZE}}{{UNIT}}; padding-bottom: 0;',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .dimax-banner-carousel .button-text',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimax-banner-carousel .button-text' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimax-banner-carousel .button-text' => 'background-color: {{VALUE}};',
				],
			]
		);
	...
	protected function section_carousel_style() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .dimax-banner-carousel .rz-swiper-button' => 'font-size: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .dimax-banner-carousel .rz-swiper-button' => 'width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .dimax-banner-carousel .rz-swiper-button' => 'height: {{SIZE}}{{UNIT}};line-height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .dimax-banner-carousel .rz-swiper-button-prev' => 'left: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .dimax-banner-carousel .rz-swiper-button-next' => 'right: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimax-banner-carousel .rz-swiper-button' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimax-banner-carousel .rz-swiper-button' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimax-banner-carousel .rz-swiper-button:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimax-banner-carousel .rz-swiper-button:hover' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .dimax-banner-carousel .swiper-pagination-bullet' => 'margin: 0 {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .dimax-banner-carousel .swiper-pagination-bullet' => 'width: {{SIZE}}{{UNIT}};height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .dimax-banner-carousel .swiper-pagination' => 'margin-top: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimax-banner-carousel .swiper-pagination-bullet:before' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimax-banner-carousel .swiper-pagination-bullet-active:before, {{WRAPPER}} .dimax-banner-carousel .swiper-pagination-bullet:hover:before' => 'background-color: {{VALUE}};',
				],
			]
		);
	...
	protected function render() {
		...
		$classes = [
			'dimax-banner-carousel swiper-container',
		...
		if ( ! empty ( $els ) ) {
			foreach ( $els as $index => $item ) {
				...
				$link_icon = $item['show_default_icon'] === 'yes' ? \Dimax\Addons\Helper::get_svg( 'arrow-right', 'dimax-icon' ) : '';

				$button_text = $item['button_text'] ? sprintf( '<span class="button-text dimax-button">%s %s</span>', $item['button_text'], $link_icon ) : '';
				$btn_full    = '';
		...
		echo sprintf(
			'<div %s>
				<div class="dimax-banner-carousel__inner swiper-wrapper">%s</div>
				%s
