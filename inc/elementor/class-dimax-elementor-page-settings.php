...
class Page_Settings {
	...
	public function add_new_page_settings_section( \Elementor\Core\DocumentTypes\PageBase $page ) {
		...
		$page->start_controls_section(
			...
			[
				'label' => esc_html__( 'Header Settings', 'dimax' ),
		...
		$page->add_control(
			...
			[
				'label'        => esc_html__( 'Hide Header Section', 'dimax' ),
		...
		$page->add_control(
			...
			[
				...
				'options'     => [
					...
					'v10'     => esc_html__('Header v10', 'dimax'),
					'v11'     => esc_html__('Header v11', 'dimax'),
				],
				'default'     => 'default',
				'label_block' => true,
			]
		...
		$page->add_control(
			...
			[
				'label'       => esc_html__( 'Header Background', 'dimax' ),
				'type'        => Controls_Manager::SELECT,
				'options'     => [
					'default'     => esc_html__( 'Default', 'dimax' ),
		...
		$page->add_control(
			...
			[
				'label'        => esc_html__( 'Hide Border Bottom', 'dimax' ),
				'type'         => Controls_Manager::SWITCHER,
				'return_value' => '1',
				'default'      => ''
		...
		$page->add_control(
			...
			[
				'label'       => esc_html__( 'Header V4 Spacing', 'dimax' ),
				'type'        => Controls_Manager::SELECT,
				'options'     => array(
					'default' => esc_html__( 'Default', 'dimax' ),
		...
		$page->add_control(
			...
			[
				'label'       => esc_html__( 'Primary Menu', 'dimax' ),
				'type'        => Controls_Manager::SELECT,
		...
		$page->add_control(
			...
			[
				'label'       => esc_html__( 'Department Menu Display', 'dimax' ),
				'type'        => Controls_Manager::SELECT,
				'options'     => array(
		...
		$page->start_controls_section(
			...
			[
				'label' => esc_html__( 'Content Settings', 'dimax' ),
				'tab'   => Controls_Manager::TAB_SETTINGS,
			]
		);
		...
		$page->add_control(
			...
			[
				'label'       => esc_html__( 'Bottom Spacing', 'dimax' ),
				'type'        => Controls_Manager::SELECT,
				'options'     => array(
					'default' => esc_html__( 'Default', 'dimax' ),
					'no'      => esc_html__( 'No spacing', 'dimax' ),
		...
		$page->start_controls_section(
			...
			[
				'label' => esc_html__( 'Page Header Settings', 'dimax' ),
				'tab'   => Controls_Manager::TAB_SETTINGS,
			]
		);
		...
		$page->add_control(
			'rz_hide_page_header',
			[
				'label'        => esc_html__( 'Hide Page Header', 'dimax' ),
				'type'         => Controls_Manager::SWITCHER,
				'return_value' => '1',
				'default'      => ''
		...
		$page->add_control(
			'rz_hide_title',
			[
				'label'        => esc_html__( 'Hide Title', 'dimax' ),
				'type'         => Controls_Manager::SWITCHER,
				'return_value' => '1',
				'default'      => ''
			]
		...
		$page->add_control(
			'rz_hide_breadcrumb',
			[
				'label'        => esc_html__( 'Hide Breadcrumb', 'dimax' ),
				'type'         => Controls_Manager::SWITCHER,
				'return_value' => '1',
				'default'      => ''
			]
		...
		$page->add_control(
			...
			[
				'label'       => esc_html__( 'Title Spacing', 'dimax' ),
				'type'        => Controls_Manager::SELECT,
				'options'     => array(
					'default' => esc_html__( 'Default', 'dimax' ),
					'custom'  => esc_html__( 'Custom', 'dimax' ),
		...
		$page->start_controls_section(
			...
			[
				'label' => esc_html__( 'Boxed Layout Settings', 'dimax' ),
				'tab'   => Controls_Manager::TAB_SETTINGS,
			]
		);
		$page->add_control(
			...
			[
				'label'        => esc_html__( 'Disable Boxed Layout', 'dimax' ),
				'type'         => Controls_Manager::SWITCHER,
				'return_value' => '1',
				'default'      => ''
		...
		$page->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}}.dimax-boxed-layout' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$page->add_control(
			...
			[
				...
				'default'   => [],
				'selectors' => [
					'{{WRAPPER}}.dimax-boxed-layout' => 'background-image: url("{{URL}}");',
				],
			]
		);
		...
		$page->add_control(
			...
			[
				...
				'label_block' => true,
				'selectors'   => [
					'{{WRAPPER}}.dimax-boxed-layout' => 'background-position-x:  {{VALUE}};',
				],
			]
		);
		...
		$page->add_control(
			...
			[
				...
				'label_block' => true,
				'selectors'   => [
					'{{WRAPPER}}.dimax-boxed-layout' => 'background-position-y:  {{VALUE}};',
				],
			]
		);
		...
		$page->add_control(
			...
			[
				...
				'label_block' => true,
				'selectors'   => [
					'{{WRAPPER}}.dimax-boxed-layout' => 'background-repeat:  {{VALUE}};',
				],
			]
		);
		...
		$page->add_control(
			...
			[
				...
				'label_block' => true,
				'selectors'   => [
					'{{WRAPPER}}.dimax-boxed-layout' => 'background-attachment:  {{VALUE}};',
				],
			]
		);
		...
		$page->add_control(
			...
			[
				...
				'label_block' => true,
				'selectors'   => [
					'{{WRAPPER}}.dimax-boxed-layout' => 'background-size:  {{VALUE}};',
				],
			]
		);
		...
		$page->start_controls_section(
			...
			[
				'label' => esc_html__( 'Footer Settings', 'dimax' ),
				'tab'   => Controls_Manager::TAB_SETTINGS,
			]
		);
		...
		$page->add_control(
			...
			[
				'label'        => esc_html__( 'Hide Footer Section', 'dimax' ),
				'type'         => Controls_Manager::SWITCHER,
				'return_value' => '1',
				'default'      => '',
		...
		$page->add_control(
			...
			[
				'label'        => esc_html__( 'Footer Border', 'dimax' ),
				'type'         => Controls_Manager::SELECT,
				'options'     => array(
					'default' => esc_html__( 'Default', 'dimax' ),
		...
		$page->add_control(
			...
			[
				'label'       => esc_html__( 'Footer Border Color', 'dimax' ),
				'type'        => Controls_Manager::SELECT,
				'options'     => array(
					'default' => esc_html__( 'Default', 'dimax' ),
					'custom'  => esc_html__( 'Custom', 'dimax' ),
