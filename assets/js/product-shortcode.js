class DimaxProductShortcodeWidgetHandler extends elementorModules.frontend.handlers.Base {
    getDefaultSettings() {
        return {
            selectors: {
        ...
        if (typeof wc_add_to_cart_variation_params !== 'undefined') {
            $variations.find('td.value select').each(function () {
                jQuery(this).on('change', function () {
                    ...
                    jQuery(this).closest('tr').find('td.label .dimax-attr-value').html(value);
                }).trigger('change');
            });
        }
    }
    ...
    getCountDownInit() {
        ...
        this.$element.find('.dimax-countdown').rz_countdown();
    }
...
class DimaxProductsMasonryWidgetHandler extends elementorModules.frontend.handlers.Base {
    getDefaultSettings() {
        return {
            selectors: {
                container: '.dimax-products-masonry'
            },
        };
    }
    ...
    productsFound() {
        var $found = this.elements.$container.find('.dimax-posts__found-inner'),
    ...
    loadProductsGrid() {
        ...
        this.elements.$container.on('click', '.woocommerce-pagination a.next', function (e) {
            ...
            var $el = jQuery(this),
                ...
                url = $el.attr('href'),
                $products = $el.closest('.dimax-products-masonry').find('ul.products'),
                $currentPosts = $products.find('li.product:not(.has-banner)').length,
                $found = $el.closest('.dimax-products-masonry').find('.dimax-posts__found');

            $nav.addClass('loading');

            jQuery.get(url, function (response) {
                var $content = jQuery(response).find('.dimax-products-masonry ul.products li.product'),
                    $navNew = jQuery(response).find('.dimax-products-masonry .woocommerce-pagination'),
                    $foundItem = jQuery(response).find('.dimax-products-masonry ul.products li.product:not(.has-banner)'),
                ...
                jQuery(document.body).trigger('dimax_products_masonry_loaded', [$content, true]);
...
class DimaxProductsDealWidgetHandler extends elementorModules.frontend.handlers.Base {
    getDefaultSettings() {
        return {
            selectors: {
                container: '.dimax-products-deal'
            },
        };
    }
...
class DimaxProductsDeal2WidgetHandler extends elementorModules.frontend.handlers.Base {
    getDefaultSettings() {
        return {
            selectors: {
                container: '.dimax-products-deal-2'
            },
        };
    }
...
class DimaxProductsShowcaseWidgetHandler extends elementorModules.frontend.handlers.Base {
    getDefaultSettings() {
        return {
            selectors: {
                container: '.dimax-products-showcase'
            },
        };
    }
...
class DimaxProductsCarouselWidgetHandler extends elementorModules.frontend.handlers.Base {
    getDefaultSettings() {
        return {
            selectors: {
                container: '.dimax-products-carousel'
            },
        };
    }
    ...
    getProductSwiperInit() {
        ...
        var spaceBetween = jQuery(document.body).hasClass('dimax-product-card-solid') ? false : true;
...
class DimaxProductOfCategoryWidgetHandler extends elementorModules.frontend.handlers.Base {
    getDefaultSettings() {
        return {
            selectors: {
                container: '.dimax-product-of-category'
            },
        };
    }
...
class DimaxProductsCategorytabsWidgetHandler extends elementorModules.frontend.handlers.Base {
    getDefaultSettings() {
        return {
            selectors: {
                container: '.dimax-product-category-tabs'
            },
        };
    }
    ...
    getProductCategory($selector, settings) {
        ...
        $list.after('<div class="swiper-pagination"></div>');
        $list.after('<span class="dimax-svg-icon rz-category-arrow-prev rz-swiper-button"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="15 18 9 12 15 6"></polyline></svg></span>');
        $list.after('<span class="dimax-svg-icon rz-category-arrow-next rz-swiper-button"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"></polyline></svg></span>');
    ...
    getCategoryAJAXHandler($el, $tabs) {
        ...
        var data = {},
            ...
            ajax_url = dimaxData.ajax_url.toString().replace('%%endpoint%%', 'ra_elementor_load_category');
...
class DimaxProductstabWidgetHandler extends elementorModules.frontend.handlers.Base {
    getDefaultSettings() {
        return {
            selectors: {
                container: '.dimax-products-tabs'
            },
        };
    }
    ...
    getProductsAJAXHandler($el, $tabs) {
        ...
        var data = {},
            elementSettings = $currentTab.data('settings'),
            ajax_url = dimaxData.ajax_url.toString().replace('%%endpoint%%', 'ra_elementor_load_products_grid');
        ...
        jQuery.post(
            ...
            function (response) {
                ...
                jQuery(document.body).trigger('dimax_products_loaded', [jQuery(content), true]);
            }
        );
    };
...
class DimaxProductstabGridWidgetHandler extends elementorModules.frontend.handlers.Base {
    getDefaultSettings() {
        return {
            selectors: {
                container: '.dimax-products-tabs-grid'
            },
        };
    }
    ...
    loadMoreProducts() {
        var ajax_url = dimaxData.ajax_url.toString().replace('%%endpoint%%', 'ra_elementor_load_products_grid');
        ...
        this.elements.$container.on('click', 'a.ajax-load-products', function (e) {
            ...
            jQuery.post(
                ...
                function (response) {
                    ...
                    // If has products
                    if ($products.length) {
                        $products.addClass('dimaxFadeInUp');
                    ...
                    jQuery(document.body).trigger('dimax_products_loaded', [$products, true]);
                }
            );
        });
    };
...
class DimaxDealsCarouselWidgetHandler extends elementorModules.frontend.handlers.Base {
    getDefaultSettings() {
        return {
            selectors: {
                container: '.dimax-deals-carousel'
            },
        };
    }
    ...
    getProductSwiperInit() {
        ...
        var $wrapper = this.elements.$container.find('.dimax-deals-carousel__inner');

        $wrapper.after('<div class="swiper-pagination"></div>');
        $wrapper.after('<span class="dimax-svg-icon rz-swiper-button-prev rz-swiper-button"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="15 18 9 12 15 6"></polyline></svg></span>');
        $wrapper.after('<span class="dimax-svg-icon rz-swiper-button-next rz-swiper-button"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"></polyline></svg></span>');
...
class DimaxDealsCarousel2WidgetHandler extends elementorModules.frontend.handlers.Base {
    getDefaultSettings() {
        return {
            selectors: {
                container: '.dimax-deals-carousel-2'
            },
        };
    }
    ...
    getProductSwiperInit() {
        ...
        var $wrapper = this.elements.$container.find('.dimax-deals-carousel-2__inner');
...
class DimaxProductsGridWidgetHandler extends elementorModules.frontend.handlers.Base {
    getDefaultSettings() {
        return {
            selectors: {
                container: '.dimax-products-grid'
            },
        };
    }
        ...
        this.elements.$container.on('click', 'a.ajax-load-products', function (e) {
            ...
            jQuery.post(
                ...
                function (response) {
                    ...
                    var $data = jQuery(response.data),
                        $products = $data.find('li.product'),
                        $container = $el.closest('.dimax-products-grid'),
                        $grid = $container.find('ul.products'),
                        $page_number = $data.find('.page-number').data('page');
    ...
    loadProductsPagination() {
        ...
        this.elements.$container.on('click', '.woocommerce-pagination a', function (e) {
            ...
            var $el = jQuery(this),
                $nav = $el.closest('.woocommerce-pagination'),
                url = $el.attr('href'),
                $products = $el.closest('.dimax-products-grid').find('ul.products');

            $nav.addClass('loading');

            jQuery.get(url, function (response) {
                var $content = jQuery(response).find('.dimax-products-grid ul.products li.product'),
                    $navNew = jQuery(response).find('.dimax-products-grid .woocommerce-pagination');

                $products.html($content);
                $nav.replaceWith($navNew);

                jQuery(document.body).trigger('dimax_products_loaded', [$content, true]);
...
class DimaxProductLoopHandler extends elementorModules.frontend.handlers.Base {
    getDefaultSettings() {
        return {
            selectors: {
...
class DimaxProductsRecentlyViewedWidgetHandler extends elementorModules.frontend.handlers.Base {
    getDefaultSettings() {
        return {
            selectors: {
                container: '.dimax-products-recently-viewed-carousel'
            },
        };
    }
    ...
    getProductsHandler () {
        ...
        jQuery(window).on('scroll', function () {
            if (jQuery(document.body).find('.dimax-products-recently-viewed-carousel').is(':in-viewport')) {
    ...
    getProductsAJAXHandler () {
        ...
        var elementSettings = $selector.data('settings'),
            ajax_url = dimaxData.ajax_url.toString().replace('%%endpoint%%', 'ra_elementor_load_recently_viewed_products');
...
class DimaxProductsRecentlyViewedWidgetGridHandler extends elementorModules.frontend.handlers.Base {
    getDefaultSettings() {
        return {
            selectors: {
                container: '.dimax-products-recently-viewed-grid'
            },
        };
    }
    ...
    resetCookie () {
        ...
        $selector.on('click', '.reset-button' , function(e){
            ...
            jQuery(this).closest('.dimax-products-recently-viewed-grid').removeClass('has-products').find('.products-content, .woocommerce-pagination').remove();
...
class DimaxProductsCarouselWithThumbnailsWidgetHandler extends elementorModules.frontend.handlers.Base {
    getDefaultSettings() {
        return {
            selectors: {
                container: '.dimax-products-carousel-with-thumbnails'
            },
        };
    }
    ...
    getProductSwiperInit() {
        ...
        $products.find('li.product').addClass('swiper-slide');
        $products.after('<div class="swiper-pagination"></div>');
        $products.after('<span class="dimax-svg-icon rz-swiper-button-prev rz-swiper-button"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="15 18 9 12 15 6"></polyline></svg></span>');
        $products.after('<span class="dimax-svg-icon rz-swiper-button-next rz-swiper-button"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"></polyline></svg></span>');
...
class DimaxProductsSliderWidgetHandler extends elementorModules.frontend.handlers.Base {
    getDefaultSettings() {
        return {
            selectors: {
                container: '.dimax-products-slider'
            },
        };
    }
    ...
    getProductSwiperInit() {
        ...
        new Swiper(this.elements.$container.find('.dimax-products-slider__wrapper'), options);
    }
...
class DimaxProductsListingWidgetHandler extends elementorModules.frontend.handlers.Base {
    getDefaultSettings() {
        return {
            selectors: {
                container: '.dimax-products-listing'
            },
        };
    }
...
jQuery(window).on('elementor/frontend/init', () => {
    ...
    elementorFrontend.hooks.addAction('frontend/element_ready/widget', ($element) => {
        elementorFrontend.elementsHandler.addHandler(DimaxProductLoopHandler, {$element});
    });

    elementorFrontend.hooks.addAction('frontend/element_ready/dimax-product-shortcode.default', ($element) => {
        elementorFrontend.elementsHandler.addHandler(DimaxProductShortcodeWidgetHandler, {$element});
    });

    elementorFrontend.hooks.addAction('frontend/element_ready/dimax-products-masonry.default', ($element) => {
        elementorFrontend.elementsHandler.addHandler(DimaxProductsMasonryWidgetHandler, {$element});
    });

    elementorFrontend.hooks.addAction('frontend/element_ready/dimax-products-deal.default', ($element) => {
        elementorFrontend.elementsHandler.addHandler(DimaxProductsDealWidgetHandler, {$element});
    });

    elementorFrontend.hooks.addAction('frontend/element_ready/dimax-products-deal-2.default', ($element) => {
        elementorFrontend.elementsHandler.addHandler(DimaxProductsDeal2WidgetHandler, {$element});
    });

    elementorFrontend.hooks.addAction('frontend/element_ready/dimax-products-showcase.default', ($element) => {
        elementorFrontend.elementsHandler.addHandler(DimaxProductsShowcaseWidgetHandler, {$element});
    });

    elementorFrontend.hooks.addAction('frontend/element_ready/dimax-product-carousel.default', ($element) => {
        elementorFrontend.elementsHandler.addHandler(DimaxProductsCarouselWidgetHandler, {$element});
    });

    elementorFrontend.hooks.addAction('frontend/element_ready/dimax-product-of-category.default', ($element) => {
        elementorFrontend.elementsHandler.addHandler(DimaxProductOfCategoryWidgetHandler, {$element});
    });

    elementorFrontend.hooks.addAction('frontend/element_ready/dimax-product-category-tabs.default', ($element) => {
        elementorFrontend.elementsHandler.addHandler(DimaxProductsCategorytabsWidgetHandler, {$element});
    });

    elementorFrontend.hooks.addAction('frontend/element_ready/dimax-product-tab.default', ($element) => {
        elementorFrontend.elementsHandler.addHandler(DimaxProductstabWidgetHandler, {$element});
    });
    elementorFrontend.hooks.addAction('frontend/element_ready/dimax-product-tab-grid.default', ($element) => {
        elementorFrontend.elementsHandler.addHandler(DimaxProductstabGridWidgetHandler, {$element});
    });

    elementorFrontend.hooks.addAction('frontend/element_ready/dimax-deals-carousel.default', ($element) => {
        elementorFrontend.elementsHandler.addHandler(DimaxDealsCarouselWidgetHandler, {$element});
    });

    elementorFrontend.hooks.addAction('frontend/element_ready/dimax-deals-carousel-2.default', ($element) => {
        elementorFrontend.elementsHandler.addHandler(DimaxDealsCarousel2WidgetHandler, {$element});
    });

    elementorFrontend.hooks.addAction('frontend/element_ready/dimax-products-grid.default', ($element) => {
        elementorFrontend.elementsHandler.addHandler(DimaxProductsGridWidgetHandler, {$element});
    });

    elementorFrontend.hooks.addAction( 'frontend/element_ready/dimax-products-recently-viewed-carousel.default', ( $element ) => {
        elementorFrontend.elementsHandler.addHandler( DimaxProductsRecentlyViewedWidgetHandler, { $element } );
    } );

    elementorFrontend.hooks.addAction( 'frontend/element_ready/dimax-products-recently-viewed-grid.default', ( $element ) => {
        elementorFrontend.elementsHandler.addHandler( DimaxProductsRecentlyViewedWidgetGridHandler, { $element } );
    } );

    elementorFrontend.hooks.addAction( 'frontend/element_ready/dimax-products-carousel-with-thumbnails.default', ( $element ) => {
        elementorFrontend.elementsHandler.addHandler( DimaxProductsCarouselWithThumbnailsWidgetHandler, { $element } );
    } );

    elementorFrontend.hooks.addAction( 'frontend/element_ready/dimax-products-slider.default', ( $element ) => {
        elementorFrontend.elementsHandler.addHandler( DimaxProductsSliderWidgetHandler, { $element } );
    } );

    elementorFrontend.hooks.addAction( 'frontend/element_ready/dimax-products-listing.default', ( $element ) => {
		elementorFrontend.elementsHandler.addHandler( DimaxProductsListingWidgetHandler, { $element } );
	} );
