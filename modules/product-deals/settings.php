...
class Settings {
	...
	public function add_deal_fields() {
        ...
        <p class="form-field _deal_quantity_field">
            <label for="_sale_quantity"><?php esc_html_e( 'Sale quantity', 'dimax' ) ?></label>
			<?php echo wc_help_tip( __( 'Set this quantity will make the product to be a deal. The sale will end when this quantity is sold out.', 'dimax' ) ); ?>
        ...
        <p class="form-field _deal_sales_counts_field">
            <label for="_sale_quantity"><?php esc_html_e( 'Sold Items', 'dimax' ) ?></label>
			<?php echo wc_help_tip( __( 'Set this sold items should be less than the sale quantity.', 'dimax' ) ); ?>
	...
	public function product_deals_section( $sections ) {
		$sections['rz_product_deals'] = esc_html__( 'Product Deals', 'dimax' );
	...
	public function product_deals_settings( $settings, $section ) {
		if ( 'rz_product_deals' == $section ) {
			...
			$settings[] = array(
				...
				'title' => esc_html__( 'Product Deals', 'dimax' ),
				'type'  => 'title',
			);
			...
			$settings[] = array(
				'id'      => 'rz_product_deals',
				'title'   => esc_html__( 'Product Deals', 'dimax' ),
				'desc'    => esc_html__( 'Enable Product Deals', 'dimax' ),
				'type'    => 'checkbox',
				'default' => 'yes',
			);
			...
			$settings[] = array(
				...
				'title'   => esc_html__( 'Expire Text', 'dimax' ),
				'type'    => 'text',
				'default' => __( 'Hurry up!<br> Sales ends soon!', 'dimax' ),
			);

			$settings[] = array(
				'id'      => 'rz_product_deals_sold_items_text',
				'title'   => esc_html__( 'Sold Items Text', 'dimax' ),
				'type'    => 'text',
				'default' => esc_html__( 'Sold Items', 'dimax' ),
			);

			$settings[] = array(
				'id'      => 'rz_product_deals_sold_text',
				'title'   => esc_html__( 'Sold Text', 'dimax' ),
				'type'    => 'text',
				'default' => esc_html__( 'Sold', 'dimax' ),
			);
