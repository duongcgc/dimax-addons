...
class Frontend {
	...
	public function __construct() {
		...
		add_action( 'dimax_woocommerce_product_quickview_summary', array( $this, 'single_product_template' ), 75 );
	...
	public static function single_product_template() {
		...
		$expire_date = apply_filters( 'dimax_product_deals_expire_timestamp', $expire_date, $product );
