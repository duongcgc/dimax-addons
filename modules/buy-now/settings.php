...
class Settings {
	...
	public function buy_now_section( $sections ) {
		$sections['rz_buy_now'] = esc_html__( 'Buy Now', 'dimax' );
	...
	public function buy_now_settings( $settings, $section ) {
		if ( 'rz_buy_now' == $section ) {
			...
			$settings[] = array(
				...
				'title' => esc_html__( 'Buy Now', 'dimax' ),
				'type'  => 'title',
			);
			...
			$settings[] = array(
				'id'      => 'rz_buy_now',
				'title'   => esc_html__( 'Buy Now', 'dimax' ),
				'desc'    => esc_html__( 'Enable Buy Now', 'dimax' ),
				'type'    => 'checkbox',
				'default' => 'no',
			);
			...
			$settings[] = array(
				...
				'type'    => 'text',
				'default' => esc_html__( 'Buy Now', 'dimax' ),
			);

			$settings[] = array(
				'name'    => esc_html__( 'Redirect Location', 'dimax' ),
				...
				'css'     => 'min-width:300px;',
				'desc_tip' => esc_html__( 'Select the page where to redirect after buy now button pressed.', 'dimax' ),
			);
