...
<div id="tamm-panel-background" class="tamm-panel-background tamm-panel">
    <p class="background-image">
        <label><?php esc_html_e( 'Background Image', 'dimax' ) ?></label><br>
        ...
        <button type="button"
                class="button remove-button {{ ! data.megaData.background.image ? 'hidden' : '' }}"><?php esc_html_e( 'Remove', 'dimax' ) ?></button>
        <button type="button" class="button upload-button"
                id="background_image-button"><?php esc_html_e( 'Select Image', 'dimax' ) ?></button>
    ...
    <p class="background-color">
        <label><?php esc_html_e( 'Background Color', 'dimax' ) ?></label><br>
    ...
    <p class="background-repeat">
        <label><?php esc_html_e( 'Background Repeat', 'dimax' ) ?></label><br>
    ...
    <p class="background-attachment">
        <label><?php esc_html_e( 'Background Attachment', 'dimax' ) ?></label><br>
        <select name="{{ taMegaMenu.getFieldName( 'background.attachment', itemId ) }}">
            ...
            }}><?php esc_html_e( 'Scroll', 'dimax' ) ?></option>
            <option value="fixed"
            {{ 'fixed' == data.megaData.background.attachment ? 'selected="selected"' : ''
            }}><?php esc_html_e( 'Fixed', 'dimax' ) ?></option>
        </select>
    </p>
</div>