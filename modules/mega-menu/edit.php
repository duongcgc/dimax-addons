...
class Edit {
	...
	public function scripts( $hook ) {
		...
		wp_enqueue_media();
		wp_enqueue_script( 'dimax-mega-menu' );
	}
            ...
            <div class="tamm-modal media-modal wp-core-ui">
                <button type="button" class="button-link media-modal-close tamm-modal-close">
                    <span class="media-modal-icon"><span
                                class="screen-reader-text"><?php esc_html_e( 'Close', 'dimax' ) ?></span></span>
                </button>
                    ...
                    <div class="tamm-frame-toolbar media-frame-toolbar">
                        <div class="tamm-toolbar media-toolbar">
                            <div class="tamm-toolbar-primary media-toolbar-primary search-form">
                                <button type="button"
                                        class="button tamm-button tamm-button-save media-button button-primary button-large"><?php esc_html_e( 'Save Changes', 'dimax' ) ?></button>
                                <button type="button"
                                        class="button tamm-button tamm-button-cancel media-button button-secondary button-large"><?php esc_html_e( 'Cancel', 'dimax' ) ?></button>
                                <span class="spinner"></span>
                            </div>
                        </div>
                    </div>
	...
	public function save_menu_item_data() {
		...
		do_action( 'dimax_save_menu_item_data', $data );
