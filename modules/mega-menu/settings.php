...
class Settings {
	...
	public function settings_api_init() {
		add_settings_section(
			'dimax_mega_menu_section',
			'<span id="mega-menu-options">' . esc_html__( 'Mega Menu', 'dimax' ) . '</span>',
		...
		add_settings_field(
			$this->option,
			'<span class="mega-menu-options">' . esc_html__( 'Mega Menu', 'dimax' ) . '</span>',
	...
	public function writing_section_html() {
		?>
        <p>
			<?php esc_html_e( 'Use these settings to disable mega menu of navigation on your site', 'dimax' ); ?>
        </p>
		<?php
	}
	...
	public function disable_field_html() {
        ...
        <label for="<?php echo esc_attr( $this->option ); ?>">
			...
			<?php esc_html_e( 'Disable Mega Menu for this site.', 'dimax' ); ?>
        </label>
