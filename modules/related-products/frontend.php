...
class Frontend {
	...
	public function related_product_cat_terms( $term_ids, $product_id ) {
		$custom_slugs = get_post_meta( get_the_ID(), 'dimax_related_cat_slugs', true );
	...
	public function related_product_tag_terms($term_ids) {
		$tag_ids = maybe_unserialize( get_post_meta( get_the_ID(), 'dimax_related_tag_ids', true ) );
	...
	public function related_products_heading() {
		return get_option( 'rz_related_products_title', esc_html__('Related Products', 'dimax') );
	}
	...
	public function related_posts_query( $query ) {
		$product_ids = maybe_unserialize( get_post_meta( get_the_ID(), 'dimax_related_product_ids', true ) );
