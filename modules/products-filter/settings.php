...
class Settings {
	...
	public function settings_api_init() {
		add_settings_section(
			'dimax_product_filter_section',
			'<span id="product-filter-options">' . esc_html__( 'Products Filter', 'dimax' ) . '</span>',
		...
		add_settings_field(
			$this->option,
			'<span class="product-filter-options">' . esc_html__( 'Products Filter', 'dimax' ) . '</span>',
	...
	public function writing_section_html() {
		?>
        <p>
			<?php esc_html_e( 'Use these settings to disable product filter of widget on catalog page', 'dimax' ); ?>
        </p>
		<?php
	}
	...
	public function disable_field_html() {
        ...
        <label for="<?php echo esc_attr( $this->option ); ?>">
			...
			<?php esc_html_e( 'Disable Product Filter for this site.', 'dimax' ); ?>
        </label>
